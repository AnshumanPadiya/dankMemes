  ...
  return (
    <div>
      ...
      <div className="hero flex w-full h-[45rem]">
        ...
        <h1 className="flex text-3xl h-[35rem] w-full justify-center items-center text-slate-50">
          DANK MEMES
        </h1>
      </div>

      <div className="flex flex-col items-center gallery h-[55rem] w-full bg-slate-200">
        <h1 className="flex justify-center items-center font-semibold text-2xl h-20">
          Explore
        </h1>
